...
export class IgxMaskDirective implements OnInit, AfterViewChecked, ControlValueAccessor {
    ...
    public onInputChanged(): void {
        ...
        switch (this._key) {
            ...
            default:
                this._end = this.selectionEnd;
                valueToParse = this.inputValue.substring(this._start, this._end);
                break;
        }

        const replacedData = this.maskParser.replaceInMask(this._oldVal, valueToParse, this.maskOptions, this._start, this._end);
